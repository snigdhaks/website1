        ...
        >
          ...
          <motion.div variants={itemVariants} className="md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <h3 className="text-xl font-bold text-gradient">ROTARACT MEC</h3>
            </div>
            ...
            <ul className="space-y-2">
              {footerLinks.map((link) => (
                <li key={link.path}>
                  <Link
                    to={link.path}
                    className="text-gray-400 hover:text-gold-400 smooth-transition text-sm"
                  >
                    {link.label}
                  </Link>
                </li>
          ...
          <motion.div variants={itemVariants}>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="mailto:rotaract@mec.ac.in" className="hover:text-gold-400 smooth-transition">
                  rotaract@mec.ac.in
                </a>
              </li>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <a
                    key={social.label}
                    href={social.url}
                    className="p-2 rounded-lg bg-dark-800 hover:bg-gradient-gold hover:text-dark-950 smooth-transition"
        ...
        <div className="border-t border-white border-opacity-10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
            ...
            <p className="mt-4 md:mt-0">
              Made with <span className="text-gold-400">💛</span> by Rotaract
            </p>
          </div>
        </div>
      </div>
